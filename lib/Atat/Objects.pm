...
package Bucket {
  ...
  has 'distribute_into';  # A list of other buckets into which this one can be distributed.
  has '_aggregated_into'; # A single parent bucket into which this one is aggregated.
